...
class CompressorProto(metaclass=ABCMeta):
    ...
    @abstractmethod
    def compress(self, source: typing.Generator[bytes, None, None]) -> typing.Generator[bytes, None, None]:
    ...
    @abstractmethod
    def decompress(self, source: typing.Generator[bytes, None, None]) -> typing.Generator[bytes, None, None]:
